    ...
    <v-container>
      <v-app-bar color="rgba(0,0,0,0)" flat >
        <v-text-field label="Search ..." class="pt-5" filled  prepend-inner-icon="mdi-magnify"
          ...
          <v-select class="mt-7" :items="items" v-model="select" item-text="state"
            color="black" solo flat style="max-width:7%;" item-color="grey darken-2">
          </v-select>
          <span text color="#878A94">Sercan NAYA</span>
          <v-avatar size="30" class="ml-2">
            <v-img src="https://www.sercannaya.com/assets/img/image-1.jpg"></v-img>
          </v-avatar>
      </v-app-bar>
      <v-row>
        <v-col cols="12" sm="8">
            ...
            <v-row>
              <v-col cols="12" sm="8">
                <v-list-item three-line>
                  <v-list-item-content>
                    <v-list-item-title class="text-h4 mb-1">Hey Sercan NAYA.</v-list-item-title>
                    <v-list-item-subtitle>
                      Wecome back Sercan NAYA. We are glad here.<br>
          ...
          <v-row class="mt-n5">
            <v-col cols="12" sm="4">
              <v-card class="rounded-xl ml-4" color="grey lighten-3" flat>
                ...
                <v-card-text class="">
                  A prototype is an early <br>sample, model or realease of a productbuilt to test a..
                </v-card-text>
            ...
            <v-col cols="12" sm="4">
              <v-card class="rounded-xl " color="black" dark elevation="10">
                ...
                <v-card-text class="">In essence, typography is the artof arranging letters and text in away that..</v-card-text>
                <v-card-actions class="mt-n7">
                  <v-list-item class="">
                    <div color="grey darken-3">        
                      <v-avatar class="ml-n3" size="30">
            ...
            <v-card class=" rounded-xl pa-4" color="grey lighten-3" flat>
              <v-app-bar  color="rgba(0,0,0,0)" tile>
                ...
                <strong class="subtitle black--text ml-2">
                  Articles Posted <span class="caption"><br>25</span>
                </strong>
                <v-spacer></v-spacer>
              ...
              <v-app-bar  color="rgba(0,0,0,0)" tile class="mt-3">
                ...
                <strong class="subtitle black--text ml-2">
                  Claps This Week <span class="caption"><br>3.7k</span>
                </strong>
                <v-spacer></v-spacer>
                <v-icon color="grey" class="ml-2">fas fa-chevron-circle-right</v-icon>
              </v-app-bar>
              <v-app-bar  color="rgba(0,0,0,0)" tile class=mt-3>
                ...
                <strong class="subtitle black--text ml-2">
                  New Followers This Week <span class="caption"><br>487</span>
                </strong>
                <v-spacer></v-spacer>
                <v-icon color="grey" class="ml-2">fas fa-chevron-circle-right</v-icon>
              </v-app-bar>
